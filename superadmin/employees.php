            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div class="password-toggle">
                        <input type="checkbox" id="show_password" title="Toggle password visibility" aria-label="Toggle password visibility">
                    </div>
                </div>
                <div class="form-group">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete_employee.php?id=<?php echo $user['id']; ?>" class="btn-action btn-delete" onclick="return confirm('Are you sure you want to permanently delete user <?php echo htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8'); ?>?');">Delete</a>
                    </td>
                </tr>
                <?php endwhile; endif; ?>
            </tbody>
