...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt_patient = $conn->prepare("INSERT INTO patients (name, age, sex, mobile_number, address, city) VALUES (?, ?, ?, ?, ?, ?)");
        $unknown_addr = 'Unknown';
        $unknown_city = 'Unknown';
        $stmt_patient->bind_param("sissss", $patient_name, $patient_age, $patient_sex, $patient_mobile, $unknown_addr, $unknown_city);
