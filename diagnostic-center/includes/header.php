    ...
    <nav class="main-navbar" id="main-nav">
        <ul>
            ...
            <?php elseif ($role === 'receptionist'): ?>
                ...
                <li><a href="existing_patients.php" class="<?php echo in_array($current_page, ['existing_patients.php', 'edit_patient.php']) ? 'active' : ''; ?>"><i class="fas fa-users"></i><span>Existing Patients</span></a></li>
